  ...
  return (
    <div id='home' className=' h-screen flex items-center justify-center mx-2'>
        ...
        <div className='  relative flex flex-col items-center'>
            ...
            <button className='transition-all hover:scale-105  text-white  max-w-[220px] rounded-md tracking-wider whitespace-nowrap text-sm md:text-base lg:text-lg w-full mx-4 '><FormModal> Free Class </FormModal></button>
