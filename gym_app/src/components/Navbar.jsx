...
export const Navbar = () => {
  ...
  return (  <div className={`z-10 text-white p-6 absolute w-full top-0 md:px-10 flex transition-all duration-200  overflow-hidden ${toggleNav ? ' h-96 shadow-xl' :' h-20'} flex-wrap items-center`}>
                ...
                <ul className="w-full relative my-8 lg:my-0 lg:w-6/12 inline-flex items-center flex-col lg:flex-row lg:justify-end ">
                    ...
                    <li className=" hover:text-primary sm:text-sm cursor-pointer m-5 uppercase tracking-wide lg:my-0">Home</li>
                    <li className=" hover:text-primary sm:text-sm cursor-pointer m-5 uppercase tracking-wide lg:my-0">Equipment</li>
                    <li className=" hover:text-primary transition-all  sm:text-sm cursor-pointer m-5 uppercase py-2 border-2 border-primary rounded-sm px-4 tracking-wide lg:my-0">Memberships</li>
                    <li className=" hover:text-primary sm:text-sm cursor-pointer m-5 uppercase tracking-wide lg:my-0">Locations</li>
                </ul>
            </div>
        );
 }
