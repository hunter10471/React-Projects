...
export const Sidebar = () => {
    ...
    <div id='sidebar' className={`flex flex-col z-[20] overflow-y-scroll lg:overflow-y-visible fixed top-0 bg-gradient-to-br from-primary to-primaryLight h-screen transition-all ${nav ? 'w-[250px]' : 'w-[55px]'} px-2 py-5`}>
        <h1 className='text-3xl font-heading font-regular flex items-center text-white mt-5 mb-10'><JoinRightIcon onClick={()=>setNav(!nav)} className='p-1 transition-all hover:scale-105 bg-white text-primary rounded-xl cursor-pointer ' sx={{fontSize:38,marginRight:0.5}} />
        {nav && 
