...
export const Table = () => {
  return (
    <table className='w-full h-full text-secondary  '>
        <tr className='sticky -top-5 bg-white h-10 border-b-2 text-lg '> 
        ...
        </tr>
            {
                data.map(el=>{
                    ...
                    <td><img className='hidden sm:block mx-10 h-[50px] w-[50px] object-cover rounded-[10%]' src={el.img} alt="" /></td>
